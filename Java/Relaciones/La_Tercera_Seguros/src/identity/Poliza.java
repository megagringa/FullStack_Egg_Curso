...
public class Poliza {
    ...
    public Poliza(int numeroPoliza, Date fechaInicio, Date fechaFin, int cantidadCuotas, String formaPago, double montoTotalAsegurado, boolean incluyeGranizo, double montoMaximoGranizo, String tipoCobertura, Vehiculo vehiculo, Cliente cliente) {
